...
public class VDCServiceImpl implements ICardService {
    ...
    public Transaction useCard(Transaction tran) {
        ...
        try {
            ...
            ChargeResponse chargeResponse = VDCCardServiceProxy.useCard(provider, tran.getCardSerial(), tran.getCardCode(), tran.getTransactionId(), session);
            ...
            if (status != null && status.intValue() == 2) {
                ...
                chargeResponse = VDCCardServiceProxy.useCard(tran.getIssuer(), tran.getCardSerial(), tran.getCardCode(), tran.getTransactionId(), session);
                status = chargeResponse.getStatus();
            }
