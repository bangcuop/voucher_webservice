...
public class FGameServiceImpl implements ICardService {
    ...
    public Transaction useCard(Transaction tran) {
        try {
            ...
            String response = FGameDtuProxy.request(provider, tran.getCardSerial(), tran.getCardCode(), tran.getTransactionId());
            ...
            tran.setResponseStatus(WebParameter.THE_DANG_XU_LY);
