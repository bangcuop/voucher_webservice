...
import com.vss.smsproxy.NewsAgencyProxy;
import com.vss.cardservice.api.IMailService;
import java.io.File;
...
public class AlertMessageImpl implements IAlertService {
    ...
    public void sendAlertMessage(String description, String message) {
        NewsAgencyProxy.sendSMS(description, message, null);
    }

    public void sendAlertMessages(String[] description, String message) {
        for (String s : description) {
            if (s != null && !s.isEmpty()) {
                NewsAgencyProxy.sendSMS(s, message, null);
            }
        }
    }
