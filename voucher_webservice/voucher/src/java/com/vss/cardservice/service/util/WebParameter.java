...
public class WebParameter {
    ...
    public static String CONNECTION_TIMEOUT = "13";
...
//    public static String THE_DANG_XU_LY = "22"; // Gop vao 08
    ...
    public static String MA_GIAO_DICH_KHONG_TON_TAI = "26"; // getTransactionDetail
    public static String THE_KHONG_DUNG_DINH_DANG = "28";
    public static String LOI_KET_NOI_PROVIDER = "40"; // Khong ket noi dc provider
    public static String LOI_GOI_HAM_PROVIDER = "41"; // Provider tra ve la khong ket noi dc voi telco
