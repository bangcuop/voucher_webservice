...
//                chargeReponse = vnptepayProxy.cardCharging(tran.getIssuer(), tran.getCardSerial(), tran.getCardCode(), tran.getTransactionId().toString(), account, session_, true);
//            } catch (Exception ex) {
//                ex.printStackTrace();
//                chargeReponse = null;
//            }
...
//                                tran.getCardCode(), tran.getTransactionId().toString(), account, session_, Boolean.TRUE);//Goi lai ham su dung card
//                    } catch (Exception ex) {
...
//                    try {
//                        session_ = vnptepayProxy.RSADecrypt(session);
//                        chargeReponse = checkTransactionStatus(tran.getTransactionId().toString(), session_);
//                    } catch (Exception ex) {
//                        ex.printStackTrace();
//                    }
//                }
...
//                    userStatus.append(WebParameter.GIAO_DICH_NGHI_VAN);
