...
public class ObjectFactory {
    ...
    private final static QName _LoginResponseMessage_QNAME = new QName("http://message.vchgws.elcom.com", "message");
    ...
    public JAXBElement<String> createLoginResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, LoginResponse.class, value);
    }
    ...
    public JAXBElement<String> createLogoutResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, LogoutResponse.class, value);
    }
    ...
    public JAXBElement<String> createChangeMPINResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, ChangeMPINResponse.class, value);
    }
    ...
    public JAXBElement<String> createChangePasswordResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, ChangePasswordResponse.class, value);
    }
    ...
    public JAXBElement<String> createLoadResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, LoadResponse.class, value);
    }
    ...
    public JAXBElement<String> createTodayEnquiryResponseMessage(String value) {
        return new JAXBElement<String>(_LoginResponseMessage_QNAME, String.class, TodayEnquiryResponse.class, value);
    }
