...
public class VcardServiceProxy extends WebserviceProxy {
...
//    }
    ...
    public static List<Payment> getPaymentList(Integer partnerId, Boolean isProvider, Integer issuerId, Integer paymentStatus, String fromDate, String toDate, boolean isAdmin, Integer start, Integer total) throws Exception {
        return getVcardWebService().getPaymentList(partnerId, isProvider, issuerId, paymentStatus, fromDate, toDate, isAdmin, start, total);
    }

    public static Integer countPaymentList(Integer partnerId, Boolean isProvider, Integer issuerId, Integer paymentStatus, String fromDate, String toDate, boolean isAdmin) throws Exception {
        return getVcardWebService().countPaymentList(partnerId, isProvider, issuerId, paymentStatus, fromDate, toDate, isAdmin);
    }

    public static void updateStatus(Integer paymentId, Integer currentStatus) throws Exception {
        getVcardWebService().updateStatus(paymentId, currentStatus);
    }
    ...
    public static void savePaidTime(Integer paymentId, Long amount, Float progress, Integer paymentMethod) throws Exception {
        getVcardWebService().savePaidTime(paymentId, amount, progress, paymentMethod);
    }
    ...
    public static Payment getPaymentListTotal(Integer partnerId, Boolean isProvider, Integer issuerId, Integer statusId, String fromDate, String toDate) throws Exception {
        return getVcardWebService().getPaymentListTotal(partnerId, isProvider, issuerId, statusId, fromDate, toDate);
    }
    ...
    public static List<PaymentHistory> getPaymentHistoryList(Integer paymentId) throws Exception {
        return getVcardWebService().getPaymentHistoryList(paymentId);
    }
    ...
    public static ContractPeriod loadContractPeriod(Integer paymentId) throws Exception {
        return getVcardWebService().loadContractPeriod(paymentId);
    }
    ...
    public static void main(String[] args) throws Exception {
        String fromDate = "01/06/2013";
        try {
            List<StatisticDay> list = getStatisticDayList(null, null, null, null, fromDate, null, 0, -1);
            for (StatisticDay statisticDay : list) {
                System.out.println("getAgentId: " + statisticDay.getAgentId() + " |getAgentName: " + statisticDay.getAgentName()
                        + " |getIssuerName: " + statisticDay.getIssuerName() + " |getLoinhuan: " + statisticDay.getLoinhuan()
                        + " |getMargin: " + statisticDay.getMargin() + " |getPartnerName: " + statisticDay.getPartnerName()
                        + " |getPhaithu: " + statisticDay.getPhaithu() + " |getPhaitra: " + statisticDay.getPhaitra()
                        + " |getProviderId: " + statisticDay.getProviderId() + " |getProviderName: " + statisticDay.getProviderName()
                        + " |getTileban: " + statisticDay.getTileban() + " |getTilemua: " + statisticDay.getTilemua()
                        + " |getTransactionDate: " + statisticDay.getTransactionDate() + " |getCardId: " + statisticDay.getCardId()
                        + " |getIssuerId: " + statisticDay.getIssuerId() + " |getPar: " + statisticDay.getPar()
                        + " |getPartnerId: " + statisticDay.getPartnerId() + " |getValue: " + statisticDay.getValue()
                        + " |getVolume: " + statisticDay.getVolume());
            }
