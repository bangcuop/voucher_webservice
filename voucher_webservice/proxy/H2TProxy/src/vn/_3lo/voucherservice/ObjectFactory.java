 ...
 * generated in the vn._3lo.voucherservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _UseCard_QNAME = new QName("http://3lo.vn/voucherservice", "useCard");
    private final static QName _GetTransactionDetail_QNAME = new QName("http://3lo.vn/voucherservice", "getTransactionDetail");
    private final static QName _GetTransactionDetailResponse_QNAME = new QName("http://3lo.vn/voucherservice", "getTransactionDetailResponse");
    private final static QName _UseCardResponse_QNAME = new QName("http://3lo.vn/voucherservice", "useCardResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: vn._3lo.voucherservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://3lo.vn/voucherservice", name = "useCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://3lo.vn/voucherservice", name = "getTransactionDetail")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://3lo.vn/voucherservice", name = "getTransactionDetailResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://3lo.vn/voucherservice", name = "useCardResponse")
