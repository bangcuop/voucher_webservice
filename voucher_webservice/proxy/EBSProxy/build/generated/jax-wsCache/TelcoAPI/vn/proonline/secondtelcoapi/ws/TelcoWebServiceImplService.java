 ...
 * 
 */
@WebServiceClient(name = "TelcoWebServiceImplService", targetNamespace = "http://ws.secondtelcoAPI.proonline.vn/", wsdlLocation = "http://123.30.169.75:8080/webservice/TelcoAPI?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TELCOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws.secondtelcoAPI.proonline.vn/", "TelcoWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://123.30.169.75:8080/webservice/TelcoAPI?wsdl");
    ...
    public TelcoWebService getTelcoWebServiceImplPort() {
        return super.getPort(new QName("http://ws.secondtelcoAPI.proonline.vn/", "TelcoWebServiceImplPort"), TelcoWebService.class);
    }
    ...
    public TelcoWebService getTelcoWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.secondtelcoAPI.proonline.vn/", "TelcoWebServiceImplPort"), TelcoWebService.class, features);
    }
