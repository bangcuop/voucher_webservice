 ...
 * generated in the vn.vcard.voucherservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTransactionDetailResponse_QNAME = new QName("http://vcard.vn/voucherservice", "getTransactionDetailResponse");
    private final static QName _UseCardResponse_QNAME = new QName("http://vcard.vn/voucherservice", "useCardResponse");
    private final static QName _UseCard_QNAME = new QName("http://vcard.vn/voucherservice", "useCard");
    private final static QName _GetTransactionDetail_QNAME = new QName("http://vcard.vn/voucherservice", "getTransactionDetail");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: vn.vcard.voucherservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vcard.vn/voucherservice", name = "getTransactionDetailResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vcard.vn/voucherservice", name = "useCardResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vcard.vn/voucherservice", name = "useCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vcard.vn/voucherservice", name = "getTransactionDetail")
